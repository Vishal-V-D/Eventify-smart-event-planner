...
;
  ...
  const handleEventSubmit = async (e) => {
    ...
    const newEvent = {
      ...
      category: formData.get('eventLocation'),
      description: formData.get('eventDescription'),
      img: formData.get('eventImage') ? formData.get('eventImage').name : null,
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        setNewEvents([...newEvents, addedEvent]);
      ...
      setNotification('Error occurred while creating the event.');
    }
  };
...
{/* Notification */}
{notification && <div className="bg-green-100 text-green-800 p-4 rounded mb-4">{notification}</div>}

<form onSubmit={handleEventSubmit} className="bg-white p-6 rounded-lg shadow-md mb-6">
  <div className="mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {newEvents.map((event, index) => (
          <div key={index} className="bg-white p-6 rounded-lg shadow-md">
            ...
            {event.img ? (
              <img src={event.img} alt={event.title} className="w-full h-48 object-cover mb-4" />
            ) : (
      ...
      <nav className="bg-gray-800 text-white w-64">
        <div className="p-6 flex flex-col items-center">
          ...
          <ul className="mt-6">
            ...
            <li>
            <button
                onClick={() => navigate('/login')} // Correct usage of navigate function
                className="flex items-center p-3 text-white hover:bg-gray-700 w-full text-left"
              >
