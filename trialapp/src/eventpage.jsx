...
import { useEvents } from './EventContext'; // Import useEvents
...
const EventPage = () => {
    const { events, loading, error } = useEvents(); // Fetch events from context
    ...
    const filteredEvents = events.filter(event =>
        ...
        (selectedKeywords.length === 0 || selectedKeywords.some(keyword =>
            ...
            <header className="bg-blue-600 dark:bg-gray-800 text-white p-4 shadow-md">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <nav className="flex space-x-6">
                        ...
                        <a href="/more" className="hover:underline">About</a>
                    ...
                    {filteredEvents.length === 0 ? (
                        ...
                        filteredEvents.map(event => (
                            <div key={event.id} className="border border-gray-300 dark:border-gray-700 rounded-lg p-4 bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
                                <img src={eventImg} alt={event.title} className="w-full h-40 object-cover rounded-lg mb-4" />
